...
class ReminderScheduler {
  ...
  // Reschedule reminders for an updated task
  async rescheduleRemindersForTask(task) {
    console.log('🔄 Rescheduling reminders for task:', task.id);
    
    // Cancel existing reminders for this task
    await this.cancelRemindersForTask(task.id);
    
    // Schedule new reminders
    await this.scheduleRemindersForTask(task);
    
    console.log('✅ Successfully rescheduled reminders for task:', task.id);
  }

  // Cancel existing reminders for a task
  async cancelRemindersForTask(taskId) {
    console.log('🗑️ Cancelling existing reminders for task:', taskId);
    ...
    try {
      ...
      console.log('✅ Cancelled existing reminders for task:', taskId);
    } catch (error) {
